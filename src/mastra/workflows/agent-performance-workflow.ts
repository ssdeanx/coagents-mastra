...
import { z } from 'zod';
import { masterAgent, supervisorAgent, analyzerAgent } from '../agents/index';
...
/**
 * Step 5: Generate and Store Detailed Report using Master Agent
 */
const generateAndStoreReportStep = createStep({
  id: 'generate-and-store-report',
  description: 'Generates a detailed performance report and stores it using the Master Agent.',
  inputSchema: z.object({
    agentName: z.string(),
    monitoringPeriod: z.string().optional(),
    analysisReport: z.string(),
